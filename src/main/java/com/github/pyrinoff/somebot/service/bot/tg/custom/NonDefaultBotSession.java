package com.github.pyrinoff.somebot.service.bot.tg.custom;
 ...
 */
public class NonDefaultBotSession implements BotSession {
    public static volatile boolean RESET_MESSAGES_ON_START = true;

    private static final Logger log = LoggerFactory.getLogger(NonDefaultBotSession.class);
    ...
    public synchronized void start() {
        ...
        lastReceivedUpdate = RESET_MESSAGES_ON_START ? -2 : 0;
                        ...
                        try {
                            ...
                            if (updates.isEmpty()) {
                                ...
                                lastReceivedUpdate = updates.parallelStream()
                                        ...
                                        .orElse(0); //RESET_MESSAGES_ON_START ? -2 : 0);
